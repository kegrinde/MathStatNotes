...
**Read:** Sections 11.1 and 11.2, through the definition of residuals (pages 520--523), and Section 3.4 in the [Stat 155 Notes](https://bcheggeseth.github.io/Stat155Notes/least-squares.html)
...
- What is the intuition behind least squares estimation?
- What are the typical steps to find a least squares estimate? 
- How can we use least squares estimation to estimate the slope and intercept of a simple linear regression model? (work through Theorem 11.2.1 in detail and fill in any steps that the textbook left out)

### In-Class Notes and Activities

See *Day 1 Slides* and *Activity 1* on [Moodle](https://moodle.macalester.edu/course/view.php?id=4532).
...
- MLE Intro (Day 2)
- MLE Example (Day 2)
- MLE Numerical Optimization (Day 3)

### In-Class Notes and Activities

- MLE "by hand": see *Day 2 Slides* and *Activity 2* on [Moodle](https://moodle.macalester.edu/course/view.php?id=4532).
- MLE by numerical techniques: see *Day 3 Slides* and *Activity 3* on [Moodle](https://moodle.macalester.edu/course/view.php?id=4532).
...
See *Day 4 Slides* and *Activity 4* on [Moodle](https://moodle.macalester.edu/course/view.php?id=4532).